        ...
        <a
          ...
          <div className="content-wrapper">
            ...
            <div className={`metadata`}>
              <p>
                {data.authors.map((author) => author.surname + ', ' + author.first_name + '; ') +
                  (data.authors.length < data.authorTotalCount ? ' et al' : '')}
              </p>
              ...
              <p>
                {data.year_published}
                {data.hasOwnProperty('publisher') ? ', ' + data.publisher.name : ''}
              </p>
            </div>
          </div>
        </a>
