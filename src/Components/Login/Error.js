    ...
    <div>
      ...
      <Grid container direction="column" justify="center" alignItems="center">
        ...
        <Grid item>
          <Card>
            <CardContent>
              <Typography variant="h4">Det har skjedd en feil</Typography>
              <hr />
              <div>
                <p>Dette kan være fordi:</p>
                <p>1. Du ikke har blitt gitt tilgang til Sentralimport av administrator</p>
              ...
              <Button variant="dark" className="errorLogoutButton" onClick={() => logIn()}>
                Logg inn
              </Button>
            </CardContent>
          </Card>
